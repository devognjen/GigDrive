...
export function buildSeedData(now: Date, passwordHash: string): SeedData {
  ...
  const trip = Object.assign(new Trip(), {
    ...
    confirmationDeadline: daysFromNow(now, 3, 11),
    departureAt: daysFromNow(now, 10, 14),
    roundTrip: true,
  ...
  const stops = [
    Object.assign(new TripStop(), {
      ...
      lat: 45.2649,
      lng: 19.8296,
      plannedTime: daysFromNow(now, 10, 14),
    }),
    Object.assign(new TripStop(), {
      id: uuid(3001),
      tripId: trip.id,
      ...
      lat: 44.985,
      lng: 20.1608,
      plannedTime: daysFromNow(now, 10, 15),
    }),
    Object.assign(new TripStop(), {
      id: uuid(3002),
      tripId: uuid(2001),
